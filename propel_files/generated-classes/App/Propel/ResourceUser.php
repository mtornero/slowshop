...
class ResourceUser extends Resource
{
    ...
    /**
     * Constructs a new ResourceUser class, setting the resource_type column to ResourceTableMap::CLASSKEY_USER.
     */
    public function __construct()
    {
        parent::__construct();
        $this->setResourceType(ResourceTableMap::CLASSKEY_USER);
    }
