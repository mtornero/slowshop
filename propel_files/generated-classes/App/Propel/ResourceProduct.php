...
class ResourceProduct extends Resource
{
    ...
    /**
     * Constructs a new ResourceProduct class, setting the resource_type column to ResourceTableMap::CLASSKEY_PRODUCT.
     */
    public function __construct()
    {
        parent::__construct();
        $this->setResourceType(ResourceTableMap::CLASSKEY_PRODUCT);
    }
