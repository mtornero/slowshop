...
use App\Propel\Map\UnitTableMap;
 ...
 *
 * @method     ChildUnitQuery leftJoinProduct($relationAlias = null) Adds a LEFT JOIN clause to the query using the Product relation
 * @method     ChildUnitQuery rightJoinProduct($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Product relation
 * @method     ChildUnitQuery innerJoinProduct($relationAlias = null) Adds a INNER JOIN clause to the query using the Product relation
 *
 * @method     ChildUnitQuery joinWithProduct($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Product relation
 *
 * @method     ChildUnitQuery leftJoinWithProduct() Adds a LEFT JOIN clause and with to the query using the Product relation
 * @method     ChildUnitQuery rightJoinWithProduct() Adds a RIGHT JOIN clause and with to the query using the Product relation
 * @method     ChildUnitQuery innerJoinWithProduct() Adds a INNER JOIN clause and with to the query using the Product relation
 *
 ...
 *
 * @method     ChildUnitQuery joinWithUnitI18n($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the UnitI18n relation
 *
 * @method     ChildUnitQuery leftJoinWithUnitI18n() Adds a LEFT JOIN clause and with to the query using the UnitI18n relation
 * @method     ChildUnitQuery rightJoinWithUnitI18n() Adds a RIGHT JOIN clause and with to the query using the UnitI18n relation
 * @method     ChildUnitQuery innerJoinWithUnitI18n() Adds a INNER JOIN clause and with to the query using the UnitI18n relation
 *
 * @method     \App\Propel\ProductQuery|\App\Propel\UnitI18nQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 *
 * @method     ChildUnit requireOneByUnitId(int $unit_id) Return the first ChildUnit filtered by the unit_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
...
abstract class UnitQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \App\Propel\Base\UnitQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'slowshop', $modelName = '\\App\\Propel\\Unit', $modelAlias = null)
    {
    ...
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = UnitTableMap::getInstanceFromPool(null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key))) && !$this->formatter) {
    ...
    {
        $sql = 'SELECT unit_id FROM unit WHERE unit_id = :p0';
        try {
    ...
    public function filterByProduct($product, $comparison = null)
    {
        if ($product instanceof \App\Propel\Product) {
            return $this
                ->addUsingAlias(UnitTableMap::COL_UNIT_ID, $product->getUnitId(), $comparison);
    ...
    public function filterByUnitI18n($unitI18n, $comparison = null)
    {
        if ($unitI18n instanceof \App\Propel\UnitI18n) {
            return $this
                ->addUsingAlias(UnitTableMap::COL_UNIT_ID, $unitI18n->getUnitId(), $comparison);
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \App\Propel\UnitI18nQuery A secondary query class using the current class as primary query
     */
    public function useUnitI18nQuery($relationAlias = null, $joinType = 'LEFT JOIN')
    {
        return $this
            ->joinUnitI18n($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'UnitI18n', '\App\Propel\UnitI18nQuery');
    }
