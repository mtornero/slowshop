...
abstract class Unit implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Propel\\Map\\UnitTableMap';
    ...
    /**
     * An array of objects scheduled for deletion.
     * @var ObjectCollection|ChildUnitI18n[]
     */
    protected $unitI18nsScheduledForDeletion = null;

    /**
     * Initializes internal state of App\Propel\Base\Unit object.
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            return $startcol + 1; // 1 = UnitTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Propel\\Unit'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->unitI18nsScheduledForDeletion !== null) {
                if (!$this->unitI18nsScheduledForDeletion->isEmpty()) {
                    \App\Propel\UnitI18nQuery::create()
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->collUnitI18ns) {
                ...
                $result[$key] = $this->collUnitI18ns->toArray(null, false, $keyType, $includeLazyLoadColumns, $alreadyDumpedObjects);
            }
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Propel\Unit The current object, for fluid interface
     */
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Propel\Unit Clone of current object.
     * @throws PropelException
     */
    ...
    public function initUnitI18ns($overrideExisting = true)
    {
        ...
        $collectionClassName = UnitI18nTableMap::getTableMap()->getCollectionClassName();

        $this->collUnitI18ns = new $collectionClassName;
        $this->collUnitI18ns->setModel('\App\Propel\UnitI18n');
    }
     ...
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     * @return ObjectCollection|ChildUnitI18n[] List of ChildUnitI18n objects
     * @throws PropelException
     */
    public function getUnitI18ns(Criteria $criteria = null, ConnectionInterface $con = null)
    {
    ...
    /**
     * Sets a collection of ChildUnitI18n objects related by a one-to-many relationship
     * to the current object.
     * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
     * and new objects from the given Propel collection.
     *
    ...
    {
        /** @var ChildUnitI18n[] $unitI18nsToDelete */
    ...
    /**
     * @param ChildUnitI18n $unitI18n The ChildUnitI18n object to add.
     */
    protected function doAddUnitI18n(ChildUnitI18n $unitI18n)
    {
    ...
    /**
     * @param  ChildUnitI18n $unitI18n The ChildUnitI18n object to remove.
     * @return $this|ChildUnit The current object (for fluent API support)
     */
    public function removeUnitI18n(ChildUnitI18n $unitI18n)
    {
        if ($this->getUnitI18ns()->contains($unitI18n)) {
            $pos = $this->collUnitI18ns->search($unitI18n);
            $this->collUnitI18ns->remove($pos);
    ...
    public function getCurrentTranslation(ConnectionInterface $con = null)
    {
        ...
        {
        return $this->getCurrentTranslation()->getUnitName();
    }
        ...
        {    $this->getCurrentTranslation()->setUnitName($v);
