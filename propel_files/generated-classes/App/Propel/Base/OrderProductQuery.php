 ...
 *
 * @method     ChildOrderProductQuery joinWithOrder($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Order relation
 *
 * @method     ChildOrderProductQuery leftJoinWithOrder() Adds a LEFT JOIN clause and with to the query using the Order relation
 * @method     ChildOrderProductQuery rightJoinWithOrder() Adds a RIGHT JOIN clause and with to the query using the Order relation
 * @method     ChildOrderProductQuery innerJoinWithOrder() Adds a INNER JOIN clause and with to the query using the Order relation
 *
...
abstract class OrderProductQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'slowshop', $modelName = '\\App\\Propel\\OrderProduct', $modelAlias = null)
    {
    ...
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = OrderProductTableMap::getInstanceFromPool(null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key))) && !$this->formatter) {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(OrderProductTableMap::COL_ORDER_PRODUCT_ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(OrderProductTableMap::COL_ORDER_PRODUCT_ID, $keys, Criteria::IN);
    }
    ...
    public function filterByOrderProductId($orderProductId = null, $comparison = null)
    {
        if (is_array($orderProductId)) {
            ...
            if (isset($orderProductId['min'])) {
                $this->addUsingAlias(OrderProductTableMap::COL_ORDER_PRODUCT_ID, $orderProductId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($orderProductId['max'])) {
                $this->addUsingAlias(OrderProductTableMap::COL_ORDER_PRODUCT_ID, $orderProductId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(OrderProductTableMap::COL_ORDER_PRODUCT_ID, $orderProductId, $comparison);
    }
    ...
    public function filterByProductQuantity($productQuantity = null, $comparison = null)
    {
        if (is_array($productQuantity)) {
            ...
            if (isset($productQuantity['min'])) {
                $this->addUsingAlias(OrderProductTableMap::COL_PRODUCT_QUANTITY, $productQuantity['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($productQuantity['max'])) {
                $this->addUsingAlias(OrderProductTableMap::COL_PRODUCT_QUANTITY, $productQuantity['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(OrderProductTableMap::COL_PRODUCT_QUANTITY, $productQuantity, $comparison);
    }
    ...
    public function filterByCreatedAt($createdAt = null, $comparison = null)
    {
        if (is_array($createdAt)) {
            ...
            if (isset($createdAt['min'])) {
                $this->addUsingAlias(OrderProductTableMap::COL_CREATED_AT, $createdAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($createdAt['max'])) {
                $this->addUsingAlias(OrderProductTableMap::COL_CREATED_AT, $createdAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(OrderProductTableMap::COL_CREATED_AT, $createdAt, $comparison);
    }
    ...
    public function filterByUpdatedAt($updatedAt = null, $comparison = null)
    {
        if (is_array($updatedAt)) {
            ...
            if (isset($updatedAt['min'])) {
                $this->addUsingAlias(OrderProductTableMap::COL_UPDATED_AT, $updatedAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($updatedAt['max'])) {
                $this->addUsingAlias(OrderProductTableMap::COL_UPDATED_AT, $updatedAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(OrderProductTableMap::COL_UPDATED_AT, $updatedAt, $comparison);
    }
    ...
    public function filterByOrder($order, $comparison = null)
    {
        if ($order instanceof \App\Propel\Order) {
            return $this
                ->addUsingAlias(OrderProductTableMap::COL_ORDER_ID, $order->getOrderId(), $comparison);
            ...
            return $this
                ->addUsingAlias(OrderProductTableMap::COL_ORDER_ID, $order->toKeyValue('PrimaryKey', 'OrderId'), $comparison);
        } else {
    ...
    {
        return $this->addUsingAlias(OrderProductTableMap::COL_UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(OrderProductTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(OrderProductTableMap::COL_UPDATED_AT);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(OrderProductTableMap::COL_CREATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(OrderProductTableMap::COL_CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(OrderProductTableMap::COL_CREATED_AT);
    }
