...
abstract class OrderProduct implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Propel\\Map\\OrderProductTableMap';
     ...
     *
     * @return $this|OrderProduct The current object, for fluid interface
     */
    ...
    public function setOrderProductId($v)
    {
        ...
        if ($this->order_product_id !== $v) {
            ...
            $this->modifiedColumns[OrderProductTableMap::COL_ORDER_PRODUCT_ID] = true;
        }
    ...
    public function setProductQuantity($v)
    {
        ...
        if ($this->product_quantity !== $v) {
            ...
            $this->modifiedColumns[OrderProductTableMap::COL_PRODUCT_QUANTITY] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->created_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[OrderProductTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->updated_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[OrderProductTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : OrderProductTableMap::translateFieldName('OrderProductId', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(OrderProductTableMap::COL_CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(OrderProductTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(OrderProductTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if (null !== $this->order_product_id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . OrderProductTableMap::COL_ORDER_PRODUCT_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(OrderProductTableMap::COL_ORDER_PRODUCT_ID)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\Propel\OrderProduct
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Propel\OrderProduct The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(OrderProductTableMap::COL_ORDER_PRODUCT_ID)) {
            $criteria->add(OrderProductTableMap::COL_ORDER_PRODUCT_ID, $this->order_product_id);
        }
        if ($this->isColumnModified(OrderProductTableMap::COL_ORDER_ID)) {
        ...
        if ($this->isColumnModified(OrderProductTableMap::COL_CREATED_AT)) {
            $criteria->add(OrderProductTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(OrderProductTableMap::COL_UPDATED_AT)) {
            $criteria->add(OrderProductTableMap::COL_UPDATED_AT, $this->updated_at);
        }
     ...
     *
     * @return     $this|ChildOrderProduct The current object (for fluent API support)
     */
