...
abstract class ResourceQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT resource_id, resource_type_id, social_views, social_likes, social_dislikes, social_comments, social_favourites, social_recommendations FROM resource WHERE resource_id = :p0';
        try {
