...
abstract class ConfigI18n implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Propel\\Map\\ConfigI18nTableMap';
    ...
    /**
     * The value for the config_name field.
     *
     * @var        string
     */
    ...
    /**
     * Initializes internal state of App\Propel\Base\ConfigI18n object.
     * @see applyDefaults()
     */
     ...
     *
     * @return $this|ConfigI18n The current object, for fluid interface
     */
    ...
    public function setConfigId($v)
    {
        ...
        if ($this->config_id !== $v) {
            $this->config_id = $v;
            $this->modifiedColumns[ConfigI18nTableMap::COL_CONFIG_ID] = true;
        }
    ...
    public function setLocale($v)
    {
        ...
        if ($this->locale !== $v) {
            $this->locale = $v;
            $this->modifiedColumns[ConfigI18nTableMap::COL_LOCALE] = true;
        }
    ...
    public function setConfigName($v)
    {
        ...
        if ($this->config_name !== $v) {
            $this->config_name = $v;
            $this->modifiedColumns[ConfigI18nTableMap::COL_CONFIG_NAME] = true;
        }
    ...
    public function setConfigDescription($v)
    {
        ...
        if ($this->config_description !== $v) {
            ...
            $this->modifiedColumns[ConfigI18nTableMap::COL_CONFIG_DESCRIPTION] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ConfigI18nTableMap::translateFieldName('ConfigId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ConfigI18nTableMap::translateFieldName('ConfigName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->config_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ConfigI18nTableMap::translateFieldName('ConfigDescription', TableMap::TYPE_PHPNAME, $indexType)];
            $this->config_description = (null !== $col) ? (string) $col : null;
            $this->resetModified();
            ...
            return $startcol + 4; // 4 = ConfigI18nTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Propel\\ConfigI18n'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ConfigI18nTableMap::COL_CONFIG_ID)) {
            $modifiedColumns[':p' . $index++]  = 'config_id';
        }
        if ($this->isColumnModified(ConfigI18nTableMap::COL_LOCALE)) {
            $modifiedColumns[':p' . $index++]  = 'locale';
        }
        if ($this->isColumnModified(ConfigI18nTableMap::COL_CONFIG_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'config_name';
        }
        if ($this->isColumnModified(ConfigI18nTableMap::COL_CONFIG_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'config_description';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'locale':
                        ...
                        break;
                    case 'config_name':
                        $stmt->bindValue($identifier, $this->config_name, PDO::PARAM_STR);
                        break;
                    case 'config_description':
                        $stmt->bindValue($identifier, $this->config_description, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['ConfigI18n'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ConfigI18n'][$this->hashCode()] = true;
        $keys = ConfigI18nTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getConfigId(),
            $keys[1] => $this->getLocale(),
            $keys[2] => $this->getConfigName(),
            $keys[3] => $this->getConfigDescription(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\Propel\ConfigI18n
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) {
            $this->setConfigDescription($arr[$keys[3]]);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Propel\ConfigI18n The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ConfigI18nTableMap::COL_CONFIG_ID)) {
            $criteria->add(ConfigI18nTableMap::COL_CONFIG_ID, $this->config_id);
        }
        if ($this->isColumnModified(ConfigI18nTableMap::COL_LOCALE)) {
            $criteria->add(ConfigI18nTableMap::COL_LOCALE, $this->locale);
        }
        if ($this->isColumnModified(ConfigI18nTableMap::COL_CONFIG_NAME)) {
            $criteria->add(ConfigI18nTableMap::COL_CONFIG_NAME, $this->config_name);
        }
        if ($this->isColumnModified(ConfigI18nTableMap::COL_CONFIG_DESCRIPTION)) {
            $criteria->add(ConfigI18nTableMap::COL_CONFIG_DESCRIPTION, $this->config_description);
        }
    ...
    {
        $criteria = ChildConfigI18nQuery::create();
        $criteria->add(ConfigI18nTableMap::COL_CONFIG_ID, $this->config_id);
        $criteria->add(ConfigI18nTableMap::COL_LOCALE, $this->locale);
    ...
    public function hashCode()
    {
        ...
        //relation config_i18n_fk_cc79ea to table config
    ...
    {
        return (null === $this->getConfigId()) && (null === $this->getLocale());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\Propel\ConfigI18n (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setConfigName($this->getConfigName());
        $copyObj->setConfigDescription($this->getConfigDescription());
        if ($makeNew) {
            $copyObj->setNew(true);
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Propel\ConfigI18n Clone of current object.
     * @throws PropelException
     */
