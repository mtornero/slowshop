...
abstract class Wishlist implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Propel\\Map\\WishlistTableMap';
    ...
    /**
     * The value for the wishlist_comment field.
     *
     * @var        string
     */
    protected $wishlist_comment;

    /**
     * The value for the wishlist_is_public field.
     *
     * @var        boolean
     */
    protected $wishlist_is_public;
    ...
    /**
     * Initializes internal state of App\Propel\Base\Wishlist object.
     */
     ...
     *
     * @return $this|Wishlist The current object, for fluid interface
     */
    ...
    /**
     * Get the [wishlist_comment] column value.
     *
     * @return string
     */
    public function getWishlistComment()
    {
        return $this->wishlist_comment;
    }

    /**
     * Get the [wishlist_is_public] column value.
     *
     * @return boolean
     */
    public function getWishlistIsGeneral()
    {
        return $this->wishlist_is_public;
    }
     ...
     * @return boolean
     */
    public function isWishlistIsGeneral()
    {
        return $this->getWishlistIsGeneral();
    }
     ...
     * @return $this|\App\Propel\Wishlist The current object (for fluent API support)
     */
    public function setWishlistName($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
    ...
    /**
     * Set the value of [wishlist_comment] column.
     *
     * @param string $v new value
     * @return $this|\App\Propel\Wishlist The current object (for fluent API support)
     */
    public function setWishlistComment($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->wishlist_comment !== $v) {
            $this->wishlist_comment = $v;
            $this->modifiedColumns[WishlistTableMap::COL_WISHLIST_COMMENT] = true;
        }
    ...
    /**
     * Sets the value of the [wishlist_is_public] column.
     ...
     * @return $this|\App\Propel\Wishlist The current object (for fluent API support)
     */
    public function setWishlistIsGeneral($v)
    {
        if ($v !== null) {
            if (is_string($v)) {
        ...
        if ($this->wishlist_is_public !== $v) {
            $this->wishlist_is_public = $v;
            $this->modifiedColumns[WishlistTableMap::COL_WISHLIST_IS_PUBLIC] = true;
        }

        return $this;
    } // setWishlistIsGeneral()
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->created_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[WishlistTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->updated_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[WishlistTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : WishlistTableMap::translateFieldName('WishlistId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : WishlistTableMap::translateFieldName('WishlistName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->wishlist_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : WishlistTableMap::translateFieldName('WishlistComment', TableMap::TYPE_PHPNAME, $indexType)];
            $this->wishlist_comment = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : WishlistTableMap::translateFieldName('WishlistIsGeneral', TableMap::TYPE_PHPNAME, $indexType)];
            $this->wishlist_is_public = (null !== $col) ? (boolean) $col : null;
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Propel\\Wishlist'), 0, $e);
        }
    }
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(WishlistTableMap::COL_CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(WishlistTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(WishlistTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(WishlistTableMap::COL_WISHLIST_COMMENT)) {
            $modifiedColumns[':p' . $index++]  = 'wishlist_comment';
        }
        if ($this->isColumnModified(WishlistTableMap::COL_WISHLIST_IS_PUBLIC)) {
            $modifiedColumns[':p' . $index++]  = 'wishlist_is_public';
        }
        if ($this->isColumnModified(WishlistTableMap::COL_CREATED_AT)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'wishlist_comment':
                        $stmt->bindValue($identifier, $this->wishlist_comment, PDO::PARAM_STR);
                        break;
                    case 'wishlist_is_public':
                        $stmt->bindValue($identifier, (int) $this->wishlist_is_public, PDO::PARAM_INT);
                        break;
                    case 'created_at':
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                return $this->getWishlistName();
                break;
            case 3:
                return $this->getWishlistComment();
                break;
            case 4:
                return $this->getWishlistIsGeneral();
                break;
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            $keys[0] => $this->getWishlistId(),
            $keys[1] => $this->getUserId(),
            $keys[2] => $this->getWishlistName(),
            $keys[3] => $this->getWishlistComment(),
            $keys[4] => $this->getWishlistIsGeneral(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\Propel\Wishlist
     */
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                $this->setWishlistName($value);
                break;
            case 3:
                $this->setWishlistComment($value);
                break;
            case 4:
                $this->setWishlistIsGeneral($value);
                break;
            case 5:
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setWishlistId($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setUserId($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setWishlistName($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setWishlistComment($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setWishlistIsGeneral($arr[$keys[4]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Propel\Wishlist The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(WishlistTableMap::COL_WISHLIST_COMMENT)) {
            $criteria->add(WishlistTableMap::COL_WISHLIST_COMMENT, $this->wishlist_comment);
        }
        if ($this->isColumnModified(WishlistTableMap::COL_WISHLIST_IS_PUBLIC)) {
            $criteria->add(WishlistTableMap::COL_WISHLIST_IS_PUBLIC, $this->wishlist_is_public);
        }
        if ($this->isColumnModified(WishlistTableMap::COL_CREATED_AT)) {
            $criteria->add(WishlistTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(WishlistTableMap::COL_UPDATED_AT)) {
            $criteria->add(WishlistTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    {
        $validPk = null !== $this->getWishlistId();
    ...
    {
        return null === $this->getWishlistId();
    }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setWishlistId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Propel\Wishlist Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildWishlist is new, it will return
    ...
    public function setWishlistProducts(Collection $wishlistProducts, ConnectionInterface $con = null)
    {
        ...
        foreach ($wishlistProductsToDelete as $wishlistProductRemoved) {
            $wishlistProductRemoved->setWishlist(null);
        }
     ...
     * Otherwise if this Wishlist is new, it will return
     * an empty collection; or if this Wishlist has previously
     * been saved, it will retrieve related WishlistProducts from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Wishlist.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildWishlistProduct[] List of ChildWishlistProduct objects
     */
    public function getWishlistProductsJoinProduct(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildWishlistProductQuery::create(null, $criteria);
