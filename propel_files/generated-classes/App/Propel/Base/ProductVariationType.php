...
/**
 * Base class that represents a row from the 'product_variation_type' table.
 *
 *
 *
* @package    propel.generator.App.Propel.Base
*/
abstract class ProductVariationType implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Propel\\Map\\ProductVariationTypeTableMap';
    ...
    /**
     * Initializes internal state of App\Propel\Base\ProductVariationType object.
     */
    ...
    /**
     * Compares this with another <code>ProductVariationType</code> instance.  If
     * <code>obj</code> is an instance of <code>ProductVariationType</code>, delegates to
     * <code>equals(ProductVariationType)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|ProductVariationType The current object, for fluid interface
     */
    ...
    public function setProductVariationTypeId($v)
    {
        ...
        if ($this->product_variation_type_id !== $v) {
            ...
            $this->modifiedColumns[ProductVariationTypeTableMap::COL_PRODUCT_VARIATION_TYPE_ID] = true;
        }
    ...
    public function setProductId($v)
    {
        ...
        if ($this->product_id !== $v) {
            $this->product_id = $v;
            $this->modifiedColumns[ProductVariationTypeTableMap::COL_PRODUCT_ID] = true;
        }
    ...
    public function setVariationTypeId($v)
    {
        ...
        if ($this->variation_type_id !== $v) {
            ...
            $this->modifiedColumns[ProductVariationTypeTableMap::COL_VARIATION_TYPE_ID] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->created_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[ProductVariationTypeTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->updated_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[ProductVariationTypeTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ProductVariationTypeTableMap::translateFieldName('ProductVariationTypeId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->product_variation_type_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ProductVariationTypeTableMap::translateFieldName('ProductId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->product_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ProductVariationTypeTableMap::translateFieldName('VariationTypeId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->variation_type_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ProductVariationTypeTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ProductVariationTypeTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 5; // 5 = ProductVariationTypeTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Propel\\ProductVariationType'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildProductVariationTypeQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see ProductVariationType::setDeleted()
     * @see ProductVariationType::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildProductVariationTypeQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(ProductVariationTypeTableMap::COL_CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(ProductVariationTypeTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(ProductVariationTypeTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                ProductVariationTypeTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[ProductVariationTypeTableMap::COL_PRODUCT_VARIATION_TYPE_ID] = true;
        if (null !== $this->product_variation_type_id) {
        ...
        if ($this->isColumnModified(ProductVariationTypeTableMap::COL_PRODUCT_VARIATION_TYPE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'product_variation_type_id';
        }
        if ($this->isColumnModified(ProductVariationTypeTableMap::COL_PRODUCT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'product_id';
        }
        if ($this->isColumnModified(ProductVariationTypeTableMap::COL_VARIATION_TYPE_ID)) {
        ...
        $sql = sprintf(
            'INSERT INTO product_variation_type (%s) VALUES (%s)',
        ...
        $this->setProductVariationTypeId($pk);
    ...
    {
        $pos = ProductVariationTypeTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['ProductVariationType'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProductVariationType'][$this->hashCode()] = true;
        $keys = ProductVariationTypeTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getProductVariationTypeId(),
            $keys[1] => $this->getProductId(),
            $keys[2] => $this->getVariationTypeId(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\Propel\ProductVariationType
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setProductVariationTypeId($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setProductId($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setVariationTypeId($arr[$keys[2]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Propel\ProductVariationType The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProductVariationTypeTableMap::COL_PRODUCT_VARIATION_TYPE_ID)) {
            $criteria->add(ProductVariationTypeTableMap::COL_PRODUCT_VARIATION_TYPE_ID, $this->product_variation_type_id);
        }
        if ($this->isColumnModified(ProductVariationTypeTableMap::COL_PRODUCT_ID)) {
            $criteria->add(ProductVariationTypeTableMap::COL_PRODUCT_ID, $this->product_id);
        }
        if ($this->isColumnModified(ProductVariationTypeTableMap::COL_VARIATION_TYPE_ID)) {
            $criteria->add(ProductVariationTypeTableMap::COL_VARIATION_TYPE_ID, $this->variation_type_id);
        }
        if ($this->isColumnModified(ProductVariationTypeTableMap::COL_CREATED_AT)) {
            $criteria->add(ProductVariationTypeTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(ProductVariationTypeTableMap::COL_UPDATED_AT)) {
            $criteria->add(ProductVariationTypeTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    {
        $criteria = ChildProductVariationTypeQuery::create();
        $criteria->add(ProductVariationTypeTableMap::COL_PRODUCT_VARIATION_TYPE_ID, $this->product_variation_type_id);
    ...
    {
        $validPk = null !== $this->getProductVariationTypeId();
    ...
    /**
     * Generic method to set the primary key (product_variation_type_id column).
     *
    ...
    {
        $this->setProductVariationTypeId($key);
    }
    ...
    {
        return null === $this->getProductVariationTypeId();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\Propel\ProductVariationType (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setProductVariationTypeId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Propel\ProductVariationType Clone of current object.
     * @throws PropelException
     */
    ...
    public function getProduct(ConnectionInterface $con = null)
    {
        if ($this->aProduct === null && ($this->product_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aProduct->addProductVariationTypes($this);
             */
        }
    ...
    public function getVariationType(ConnectionInterface $con = null)
    {
        if ($this->aVariationType === null && ($this->variation_type_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aVariationType->addProductVariationTypes($this);
             */
        }
     ...
     * If this ChildProductVariationType is new, it will return
        ...
        if (null === $this->collProductVariations || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collProductVariations) {
                ...
                $collProductVariations = ChildProductVariationQuery::create(null, $criteria)
                    ->filterByProductVariationType($this)
                    ->find($con);
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildProductVariationType The current object (for fluent API support)
     */
    public function setProductVariations(Collection $productVariations, ConnectionInterface $con = null)
    {
        ...
        foreach ($productVariationsToDelete as $productVariationRemoved) {
            $productVariationRemoved->setProductVariationType(null);
        }
    ...
    protected function doAddProductVariation(ChildProductVariation $productVariation)
    {
        ...
        $productVariation->setProductVariationType($this);
    }
    ...
    public function removeProductVariation(ChildProductVariation $productVariation)
    {
        if ($this->getProductVariations()->contains($productVariation)) {
            ...
            $productVariation->setProductVariationType(null);
        }
     ...
     * Otherwise if this ProductVariationType is new, it will return
     * an empty collection; or if this ProductVariationType has previously
     * been saved, it will retrieve related ProductVariations from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in ProductVariationType.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildProductVariation[] List of ChildProductVariation objects
     */
    public function getProductVariationsJoinVariation(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildProductVariationQuery::create(null, $criteria);
        $query->joinWith('Variation', $joinBehavior);
    ...
    {
        return (string) $this->exportTo(ProductVariationTypeTableMap::DEFAULT_STRING_FORMAT);
    }
