...
class OrderProductTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'App.Propel.Map.OrderProductTableMap';
     ...
     */
    const OM_CLASS = '\\App\\Propel\\OrderProduct';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'App.Propel.OrderProduct';
     ...
     */
    const COL_ORDER_PRODUCT_ID = 'order_product.order_product_id';
     ...
     */
    const COL_PRODUCT_QUANTITY = 'order_product.product_quantity';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'order_product.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'order_product.updated_at';
    ...
    {
        $this->addRelation('Order', '\\App\\Propel\\Order', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':order_id',
    1 => ':order_id',
  ...
  array (
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(OrderProductTableMap::COL_ORDER_PRODUCT_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(OrderProductTableMap::COL_ORDER_PRODUCT_ID) && $criteria->keyContainsValue(OrderProductTableMap::COL_ORDER_PRODUCT_ID) ) {
