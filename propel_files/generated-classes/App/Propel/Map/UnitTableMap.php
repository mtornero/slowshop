...
class UnitTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'App.Propel.Map.UnitTableMap';
     ...
     */
    const OM_CLASS = '\\App\\Propel\\Unit';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'App.Propel.Unit';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('UnitId', ),
        self::TYPE_CAMELNAME     => array('unitId', ),
        self::TYPE_COLNAME       => array(UnitTableMap::COL_UNIT_ID, ),
        self::TYPE_FIELDNAME     => array('unit_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('UnitId' => 0, ),
        self::TYPE_CAMELNAME     => array('unitId' => 0, ),
        self::TYPE_COLNAME       => array(UnitTableMap::COL_UNIT_ID => 0, ),
        self::TYPE_FIELDNAME     => array('unit_id' => 0, ),
        self::TYPE_NUM           => array(0, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\App\\Propel\\Unit');
        $this->setPackage('App.Propel');
        $this->setUseIdGenerator(false);
        // columns
        $this->addPrimaryKey('unit_id', 'UnitId', 'TINYINT', true, 3, null);
    } // initialize()
  ...
  array (
    ...
    1 => ':unit_id',
        ...
        $this->addRelation('UnitI18n', '\\App\\Propel\\UnitI18n', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':unit_id',
    1 => ':unit_id',
  ),
), 'CASCADE', null, 'UnitI18ns', false);
    } // buildRelations()
    ...
    {
        return array(
            'i18n' => array('i18n_table' => '%TABLE%_i18n', 'i18n_phpname' => '%PHPNAME%I18n', 'i18n_columns' => 'unit_name', 'i18n_pk_column' => '', 'locale_column' => 'locale', 'locale_length' => '5', 'default_locale' => '', 'locale_alias' => '', ),
        );
    } // getBehaviors()
    /**
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\Propel\Unit) { // it's a model object
