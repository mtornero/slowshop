...
class FileTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'App.Propel.Map.FileTableMap';
     ...
     */
    const OM_CLASS = '\\App\\Propel\\File';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'App.Propel.File';
     ...
     */
    const COL_FILE_ID = 'file.file_id';
     ...
     */
    const COL_FILE_PATH = 'file.file_path';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('FileId', 'FileTypeId', 'FilePath', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('fileId', 'fileTypeId', 'filePath', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(FileTableMap::COL_FILE_ID, FileTableMap::COL_FILE_TYPE_ID, FileTableMap::COL_FILE_PATH, FileTableMap::COL_CREATED_AT, FileTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('file_id', 'file_type_id', 'file_path', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('FileId' => 0, 'FileTypeId' => 1, 'FilePath' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, ),
        self::TYPE_CAMELNAME     => array('fileId' => 0, 'fileTypeId' => 1, 'filePath' => 2, 'createdAt' => 3, 'updatedAt' => 4, ),
        self::TYPE_COLNAME       => array(FileTableMap::COL_FILE_ID => 0, FileTableMap::COL_FILE_TYPE_ID => 1, FileTableMap::COL_FILE_PATH => 2, FileTableMap::COL_CREATED_AT => 3, FileTableMap::COL_UPDATED_AT => 4, ),
        self::TYPE_FIELDNAME     => array('file_id' => 0, 'file_type_id' => 1, 'file_path' => 2, 'created_at' => 3, 'updated_at' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\App\\Propel\\File');
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(FileTableMap::COL_FILE_PATH);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\Propel\File) { // it's a model object
